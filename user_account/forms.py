...
class MySignUpForm(UserCreationForm):
    ...
    def __init__(self, *args, **kwargs):
        ...
        self.fields['password1'].help_text = "<ul class='form-text text-muted'>" \
                                                "<small>" \
                                                "<li>Your password can’t be too similar " \
...
class MyEditProfileForm(UserChangeForm):
    ...
    def __init__(self, *args, **kwargs):
        super(MyEditProfileForm, self).__init__(*args, **kwargs)
...
class MyPasswordChangeForm(PasswordChangeForm):
    def __init__(self, *args, **kwargs):
        ...
        self.fields['new_password1'].help_text = "<ul class='form-text text-muted'>" \
                                                "<small>" \
                                                "<li>Your password can’t be too similar " \
                                                "to your other personal information.</li>" \
                                                "<li>Your password must contain at least 8 characters.</li>" \
